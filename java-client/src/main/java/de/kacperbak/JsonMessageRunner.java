 ...
 */
public class JsonMessageRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(JsonMessageRunner.class);
    private static final Scanner SCANNER =  new Scanner(System.in);

    private StompSession stompSession;
    private StompSession.Subscription subscription;

    public JsonMessageRunner(StompSession stompSession, StompSession.Subscription subscription) {
